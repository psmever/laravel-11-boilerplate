...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         *
         *
         * @see \App\Providers\RequestLocalsMergeServiceProvider::register()
         * @param string $mergeName
         * @param string $mergeValue
         * @static
         */        public static function LocalsMergeMacro($mergeName, $mergeValue)
        {
                        return \Illuminate\Http\Request::LocalsMergeMacro($mergeName, $mergeValue);
        }
            }
            /**
     *
     ...
     */        class Response {
         ...
         * @static
         */        public static function SuccessNoContentMacro()
        {
                        return \Illuminate\Routing\ResponseFactory::SuccessNoContentMacro();
        }
                    /**
         * 결과 커스텀 하게 사용.
         *
         * @see \App\Providers\ResponseMacroServiceProvider::boot()
         * @param mixed $paramData
         * @param mixed $message
         * @param int $statusCode
         * @static
         */        public static function SuccessMacro($paramData = null, $message = null, $statusCode = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::SuccessMacro($paramData, $message, $statusCode);
        }
                    /**
         ...
         * @param int $statusCode
         * @param string|null $message
         * @param \Throwable|null $errors
         * @static
         */        public static function ErrorMacro($statusCode = 400, $message = null, $errors = null)
        {
                        return \Illuminate\Routing\ResponseFactory::ErrorMacro($statusCode, $message, $errors);
        }
            }
            /**
     *
...
namespace  {
            ...
            class PolyHelper extends \App\Helpers\PolyHelper {}
            class ServiceGenerate extends \App\Helpers\ServiceGenerate {}
    }
